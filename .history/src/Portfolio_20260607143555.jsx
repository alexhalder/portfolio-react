...
const Portfolio = () => {
    ...
    return (
        <div className="container">
            ...
            <section id="about" className="reveal fade-bottom">
                <div className="section-content">
                    <div className="about-content">
                        <div className="about-cube reveal fade-right" style={{ justifyContent: 'flex-start', flex: '1' }}>
                        ...
                        <div className="about-text reveal fade-left" style={{ flex: '1.5', paddingLeft: '40px' }}>
                            <h2>About Me</h2>
            ...
            {/* Education Section */}
            <section id="education" className="reveal fade-top">
                <div className="section-content">
                    <div className="education-content">
                        <h2 className="section-title reveal scale-in">Education</h2>
                        <div className="timeline">
                            {education?.items?.map((item, index) => (
                                <div key={index} className="timeline-item reveal zoom-fade" style={{ transitionDelay: `${index * 0.1}s` }}>
            ...
            {/* Skills Section */}
            <section id="skills" className="reveal blur-fade">
                ...
                <div className="section-content">
                    <div className="skills-content">
                        <h2 className="section-title reveal scale-in">Skills</h2>
                        <div className="skills-container">
                            {skills?.items?.map((skill, index) => {
                                ...
                                return (
                                    <div key={index} className={`skill-card ${skill.class} reveal rotate-in`} style={{ transitionDelay: `${index * 0.08}s` }}>
            ...
            <section id="projects" className="reveal fade-bottom">
                <div className="section-content" style={{ flexDirection: 'column' }}>
                    <h2 className="section-title reveal bounce-in">My Projects</h2>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', width: '100%' }}>
                        {projects?.items?.map((project, index) => (
                            <div key={index} className="skill-card reveal zoom-fade" style={{ padding: '0', overflow: 'hidden', textAlign: 'left', transitionDelay: `${index * 0.12}s` }}>
            ...
            {/* Contact Section */}
            <section id="contact" className="reveal slide-up-rotate">
                <div className="section-content">
                    <div className="contact-content">
                        <div className="contact-info">
                            <h2 className="section-title reveal flip-in">Contact Me</h2>
            ...
            <footer className="reveal blur-fade">
